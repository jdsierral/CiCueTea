% NSGFCQTINIT  Initialize Nonstationary Gabor Frame for CQT
%   s = nsgfCQTInit(type, fs, nSamps, frac, fMin, fMax, fRef, th)
%
...
function s = nsgfCQTInit(type, fs, nSamps, frac, fMin, fMax, fRef, th)
    ...
    bax = fRef * 2.^(frac * (-nBandsDn:nBandsUp)');  % Center frequencies
